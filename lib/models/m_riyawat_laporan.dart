...
//
//     final ModelRiwayatLaporan = ModelRiwayatLaporanFromJson(jsonString);
...
class ModelRiwayatLaporan {
  ...
  int code;
  String message;
  List<DataRiwayatLaporan> data;

  factory ModelRiwayatLaporan.fromJson(Map<String, dynamic> json) => ModelRiwayatLaporan(
    status: json["status"],
    code: json["code"],
    message: json["message"],
    data: List<DataRiwayatLaporan>.from(json["data"].map((x) => DataRiwayatLaporan.fromJson(x))),
  );
...
class DataRiwayatLaporan {
  ...
  factory DataRiwayatLaporan.fromJson(Map<String, dynamic> json) => DataRiwayatLaporan(
    id: json["id"],
