...
class VDetailLaporan extends StatefulWidget {
  final DataLaporan dataLaporan;
  final bool isRiyawat;

  const VDetailLaporan({Key key, this.dataLaporan, this.isRiyawat=false}) : super(key: key);
  @override
  _VDetailLaporanState createState() => _VDetailLaporanState();
}

class _VDetailLaporanState extends State<VDetailLaporan> {
...
//  static const LatLng _center = const LatLng(-6.4082937, 108.2797067);
  ...
  void acceptLaporan({String id}) async {
    ...
    AwesomeDialog(
        ...
        btnOkOnPress: () async {
          Provider.of<ProviderBerita>(context,listen: false).updateStatus(context: context,id: widget.dataLaporan.id.toString(),status: "diterima",tindakLanjut: "sedang dalam proses petugas");
        }).show();
  }
  ...
  Future<void> getSession()async{
    ...
    setState(() {
      ...
      print("level "+level);
      idPetugas=prefs.get("id");

    });
  }

  Future<Widget> editStatus(BuildContext context) async {
...
//                                          barrierColor: Colors.red,
      ...
      builder: (context) => StatefulBuilder(builder :( BuildContext context,setState)=> Container(
          ...
          child: MediaQuery.removePadding(context: context,
            ...
            child: ListView(
              ...
              children: [
                SizedBox(height: 25,),
                Center(child: Text("Tindak Lanjut",style: GoogleFonts.pTSansCaption(fontWeight: FontWeight.bold),),),
                SizedBox(height: 20,),
                Text("Status Laporan"),
                DropdownButton(
                  isExpanded: true,
                  hint: Text('Pilih Status'), // Not necessary for Option 1
                ...
                Container(
                  ...
                  child: RaisedButton(
                    onPressed: () {
                      Provider.of<ProviderBerita>(context,listen: false).updateStatus(context: context,id: widget.dataLaporan.id.toString(),status: _selectedLevel,tindakLanjut: controller.text).then((value) {
                        Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
         level.toString().toLowerCase()=="petugas" ? widget.dataLaporan.detailPetugas!=null ? IconButton(
          onPressed:()=> editStatus(context),
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: widget.dataLaporan.statusLaporan=="ditolak" ? Colors.red :Colors.green),
                                child: Row(
