...
class UbahPasswordView extends StatefulWidget {
  ...
  @override
  _UbahPasswordViewState createState() => _UbahPasswordViewState();
}
      ...
      body: Container(
          ...
          child: Stack(children: <Widget>[
            Container(
              ...
              // padding: EdgeInsets.symmetric(vertical:ScreenConfig.blockVertical*20 ,horizontal:ScreenConfig.blockHorizontal*3),
              // width: MediaQuery.of(context).size.width,
              child: Center(
                child: Text(
                  "Silahkan Isi Form Dibawah Untuk Merubah Kata Sandi",
